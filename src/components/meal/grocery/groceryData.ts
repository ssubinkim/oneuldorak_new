...
export const STORAGE_RECIPES: StorageRecipe[] = [
  { id: 1, image: bibimbapImg, channel: '도시락락락', name: '비빔밥', likes: 452, price: '3,000원', time: '20분', difficulty: '쉬움' },
  { id: 2, image: bulgogiImg, channel: '프로집밥러', name: '불고기 덮밥', likes: 375, price: '8,000원', time: '30분', difficulty: '보통' },
  { id: 3, image: chamchiImg, channel: '자취요리왕', name: '참치마요 덮밥', likes: 281, price: '4,000원', time: '15분', difficulty: '쉬움' },
  { id: 4, image: kimbokImg, channel: '도시락락락', name: '김치볶음밥', likes: 198, price: '3,500원', time: '20분', difficulty: '쉬움' },
  { id: 5, image: omuriceImg, channel: '프로집밥러', name: '오므라이스', likes: 520, price: '5,000원', time: '25분', difficulty: '보통' },
  { id: 6, image: ssoyaImg, channel: '자취요리왕', name: '소시지 야채볶음', likes: 344, price: '4,500원', time: '15분', difficulty: '쉬움' },
]
