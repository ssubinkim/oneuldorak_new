...
export const weeklyMenuData: DayMenu[] = [
  {
    ...
    savedAmount: 2000, difficulty: 2, usage: 90, recipeId: 'recipe-1',
    ingredients: [
  ...
  },
  {
    ...
    savedAmount: 3200, difficulty: 2, usage: 40, recipeId: 'recipe-2',
    ingredients: [
  ...
  },
  {
    ...
    savedAmount: 2500, difficulty: 1, usage: 100, recipeId: 'recipe-3',
    ingredients: [
  ...
  {
    day: '목', date: 4, month: 5, status: 'planned',
    image: wednesdayMenuImg,
    name: '두부 된장찌개', time: '20분',
    description: '부드러운 두부와 구수한 된장의 조화, 따뜻한 한 끼!',
    savedAmount: 2200, difficulty: 1, usage: 80, calories: 230,
    ingredients: [
      { name: '두부', image: tofuImg },
      { name: '양파', image: onionImg },
      { name: '마늘', image: garlicImg },
      { name: '당근', image: carrotImg },
      { name: '콩나물', image: beansproutsImg },
    ],
  },
  {
