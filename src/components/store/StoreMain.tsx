...
const BEST_PRODUCTS: Product[] = [
  { id: '1', brand: '모노메이트', name: '간편 도시락 세트', price: 32000, image: best1, rating: 4.9, reviewCount: 267 },
  { id: '2', brand: '밥픽', name: '계란말이 도시락', price: 4900, image: best2, rating: 4.9, reviewCount: 267 },
  { id: '3', brand: '밥픽', name: '참치마요 덮밥', price: 5900, image: best3, rating: 4.9, reviewCount: 267 },
  { id: '4', brand: '모노메이트', name: '전자레인지 런치박스', price: 9900, image: best4, rating: 4.9, reviewCount: 267 },
  { id: '5', brand: '프레시잇', name: '오늘의야채 샐러드', price: 12000, image: best5, rating: 4.9, reviewCount: 267 },
]

const SUBSCRIPTION_PRODUCTS: Product[] = [
  { id: '1', brand: '모노메이트', name: '2칸 컬러풀 도시락', price: 12000, image: sub1, rating: 4.9, reviewCount: 267 },
  { id: '2', brand: '파머스픽', name: '아보카도 계란 샐러드', price: 8600, image: sub2, rating: 4.9, reviewCount: 267 },
  { id: '3', brand: '파머스픽', name: '훈제연어 샐러드', price: 9600, image: sub3, rating: 4.9, reviewCount: 267 },
  { id: '4', brand: '프레시잇', name: '제육볶음 밀키트', price: 10000, image: sub4, rating: 4.9, reviewCount: 267 },
...
const KITCHEN_PRODUCTS: Product[] = [
  ...
  { id: '2', brand: '모노메이트', name: '저당 칼로볼', price: 29000, image: kitchen2, rating: 4.8, reviewCount: 182 },
  { id: '3', brand: '모노메이트', name: '500ml 보온 텀블러', price: 15000, image: kitchen3, rating: 4.7, reviewCount: 95 },
  { id: '4', brand: '모노메이트', name: '도시락 보냉가방', price: 11000, image: kitchen4, rating: 4.9, reviewCount: 267 },
