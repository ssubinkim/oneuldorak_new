  ...
  return (
    ...
    <div>
      ...
      <div className="review-banner">
        ...
        <img src={reviewBanner} alt="리뷰 배너" className="review-banner__img" width={150} height={120} loading="lazy" decoding="async" fetchPriority="low" />
      </div>
      ...
      <div className="review-photos">
        ...
        <div className="review-photos__list">
          ...
          <img className="review-photo-thumb" src={subreview1} alt="포토 리뷰 1" width={88} height={88} loading="lazy" decoding="async" fetchPriority="low" style={{ objectFit: 'cover' }} />
          <img className="review-photo-thumb" src={subreview2} alt="포토 리뷰 2" width={88} height={88} loading="lazy" decoding="async" fetchPriority="low" style={{ objectFit: 'cover' }} />
        </div>
      </div>
            ...
            {r.photos && r.photos.length > 0 && (
              <div className="review-card__photos">
                <div className="review-card__photo-main" style={{ position: 'relative' }}>
                  <img src={subreview1} alt="리뷰 사진 1" width={220} height={220} loading="lazy" decoding="async" fetchPriority="low" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', borderRadius: 10 }} />
                </div>
                <div className="review-card__photo-col">
                  <div className="review-card__photo-small">
                    <img src={subreview3} alt="리뷰 사진 3" width={106} height={106} loading="lazy" decoding="async" fetchPriority="low" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', borderRadius: 10 }} />
                  </div>
                  <div className="review-card__photo-small">
                    <img src={subreview4} alt="리뷰 사진 4" width={106} height={106} loading="lazy" decoding="async" fetchPriority="low" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', borderRadius: 10 }} />
                    {r.photos.length > 2 && (
