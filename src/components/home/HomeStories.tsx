...
const stories = [
  { id: 1, title: '자취생 추천! 가성비 반찬 레시피 모음', likes: 100, comments: 88, thumbnailImage: subreview1 },
  { id: 2, title: '일주일 3만원 식비 도전기', likes: 96, comments: 65, thumbnailImage: subreview2 },
  { id: 3, title: '요리 초보 탈출한 계기', likes: 65, comments: 52, thumbnailImage: subreview3 },
  { id: 4, title: '도시락 꿀팁 알려줌', likes: 43, comments: 35, thumbnailImage: subreview1 },
  { id: 5, title: '맛집 알려줄게 다 들어와~~~', likes: 36, comments: 13, thumbnailImage: subreview2 },
]
