...
export const hotPosts = [
  { id: 'hot-1', rank: 1, title: '도시락 싸기 전후 식비 비교해봤어요', likes: 100, comments: 14 },
  { id: 'hot-2', rank: 2, title: '오늘의 도시락 대실패 인증합니다', likes: 96, comments: 12 },
  { id: 'hot-3', rank: 3, title: '저는 일요일 밤에 3일치만 준비해요', likes: 65, comments: 13 },
]
